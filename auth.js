class API {
    ...
    async get(path, token = "") {
        ...
        if (!response.ok) {
            ...
            console.log(json);
            throw new console.error(`HTTP error! status:${response.status} FULL:${response.statusText}`)
        };
    ...
    async register (data = {username: "string",fullnName: "string",password: "string"}){
